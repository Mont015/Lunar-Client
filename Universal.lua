...
local vapeAssetTable = {["vape/assets/VapeCape.png"] = "rbxassetid://18738356146", ["vape/assets/ArrowIndicator.png"] = "rbxassetid://13350766521"}
...
local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/Mont015/Lunar-Client/"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
		assert(suc, res)
